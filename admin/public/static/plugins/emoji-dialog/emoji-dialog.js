...
(function() {
	...
	var factory = function (exports) {
		...
		exports.fn.emojiDialog = function() {
			...
			var category = ["Font awesome","Twemoji", "ReleFont", "Github emoji"];
            ...
            var emojiCategories = ["font-awesome","twemoji","relefont","github-emoji"];
                    ...
                    for (var i = 0; i < pageTotal; i++)
                    {
                        ...
                        for (var x = 0; x < rowNumber; x++)
                        {
                            ...
                            if (typeof emoji !== "undefined" && emoji !== "")
                            {
                                ...
                                else if (type === "relefont")
                                {
                                    icon = "<i class=\"ir ir-" + emoji + " ir-emoji\" title=\"" + emoji + "\"></i>";
                                    row += "<a href=\"javascript:;\" value=\":ir-" + emoji + ":\" title=\":ir-" + emoji + ":\" class=\"" + classPrefix + "emoji-btn\">" + icon + "</a>";
                                }
